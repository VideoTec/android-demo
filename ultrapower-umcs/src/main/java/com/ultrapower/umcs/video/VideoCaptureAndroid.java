...
public class VideoCaptureAndroid implements PreviewCallback, Callback {
  ...
  private synchronized boolean startCapture(
    ...
    try {
      ...
      SurfaceView surfaceView = ViERenderer.GetLocalRenderer();
      localPreview = surfaceView == null ? null : surfaceView.getHolder();
...
//  	  parameters.setSceneMode(Camera.Parameters.SCENE_MODE_AUTO);
  ...
  private synchronized void setPreviewRotation(int rotation) {
    ...
    if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
      ...
      //on some pad (when camera is on right side of a pad) the next code make video upside down
      //so comment these code,by zhangpeng 20151110
//      if(resultRotation == 180)
//      {
//    	  resultRotation = 0;
//      }else if(resultRotation == 0)
//      {
//    	  resultRotation = 180;
//      }
